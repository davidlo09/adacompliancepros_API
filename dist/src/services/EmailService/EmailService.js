...
class EmailService {
    ...
    static sendMail(payload) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                return yield this.emailTransporter.sendMail(Object.assign(Object.assign({}, payload), { from,
                    bcc,
                    replyTo }));
            }
            catch (error) {
...
EmailService.emailTransporter = nodemailer_1.default.createTransport(configs.emailTransporter);
